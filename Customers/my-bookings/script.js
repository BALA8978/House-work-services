...
document.addEventListener('DOMContentLoaded', function() {
    ...
    fetchBookingHistory();
    fetchRecurringServices();
    // initializeButtonListeners(); // This will be replaced
    ...
    // --- Function to fetch and display available recurring services in the modal ---
...
// --- Existing async functions (fetchBookingHistory, fetchRecurringServices) remain unchanged ---
